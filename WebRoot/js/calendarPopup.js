...
// function to write the source from a div
...
// blank function -- use as dummy in some HREFs	
function n() {
}

function enableDatepicker(input) {
  var inputName ='anchor'+input;
  document.getElementById(inputName).innerHTML= '<IMG ALT="Pick a Date" STYLE=cursor:hand SRC=img/cal.gif BORDER=0 HEIGHT=16 WIDTH=16>';
}

function disableDatepicker(input) {
  var inputName ='anchor'+input;
  document.getElementById(inputName).innerHTML= '<IMG STYLE=cursor:default SRC=img/calDim.gif BORDER=0 HEIGHT=16 WIDTH=16>';
}
